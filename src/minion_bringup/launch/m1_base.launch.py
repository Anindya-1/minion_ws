...
def generate_launch_description():
    ...
    controller_manager_config = PathJoinSubstitution(
        [
            ...
            'config',
            'm1_hardware_controller_manager.yaml',
        ]
    )
    ...
    control_node = Node(
        ...
        remappings=[
            # ('robot_description', 'm1/robot_description'),
    ...
    joint_state_broadcaster_spawner = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['joint_state_broadcaster', '--controller-manager', '/m1/controller_manager'],
        output='screen',
    )
    ...
    diff_drive_controller_spawner = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['diff_drive_controller', '--controller-manager', '/m1/controller_manager'],
        output='screen',
        condition=UnlessCondition(use_sim)
    )
    ...
    imu_broadcaster_spawner = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['imu_broadcaster', '--controller-manager', '/m1/controller_manager'],
        output='screen',
    )
    ...
    arm_controller_spawner = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['arm_controller', '--controller-manager', '/m1/controller_manager'],
        output='screen',
    )
    ...
    gripper_controller_spawner = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['gripper_controller', '--controller-manager', '/m1/controller_manager'],
        output='screen',
    )
